...
import img from 'Assets/destinations1.jpg';

import africa from 'Assets/africa.jpg';
import asia from 'Assets/asia.jpg';
import europe from 'Assets/europe.jpg';
import oceania from 'Assets/oceania.jpg';
import polarIslands from 'Assets/polarIslands.jpg';
import america from 'Assets/america.jpg';
import goodflyDestPromo from 'Assets/goodflyDestinations.png';
         ...
         <Grid container sx={{ mt: 13 }}>
            <Grid item xs={12} sm={6}>
               <Typography variant='subtitle1' color='text.secondary'>
                  ...
                  destinations. It's up to you to choose the one that
                  will be closest to you and your desires of the
                  moment.
               </Typography>
               <Typography
                  variant='subtitle1'
                  ...
                  sx={{ mt: 2 }}
               >
                  Dream your next adventure with travelogues, stories
                  from elsewhere, great encounters, ideas for
                  destinations and you will only have to go from dream
                  to reality ...
               </Typography>
            </Grid>
