...
import img from 'Assets/createTrip.jpg';
      ...
      <Container>
         ...
         <Box sx={{ fontStyle: 'italic', mt: 7 }}>
            <Typography variant='h5' color='text.secondary'>
               ...
               your desires and your principles.
            </Typography>
            <Typography
               variant='h5'
               sx={{ mt: 3 }}
            ...
            >
               Because understanding is above all knowing how to
               listen, a dedicated advisor will follow your request
               and accompany you throughout your trip ...
            </Typography>
         </Box>
         <Paper
            elevation={0}
         ...
         >
            <Typography variant='subtitle1'>
               Describe to us as precisely as possible the trip you
               would like:
            </Typography>
            <Typography variant='subtitle1'>
               stages, desires, routes, activities, excursions,
               circuits, centers of interest etc ...
            </Typography>

            <Typography variant='subtitle1' sx={{ mt: 2 }}>
               The information you give us allows us to best respond
               to your request.
            </Typography>
            <Typography variant='subtitle1' sx={{ mt: 2 }}>
               In any case, we will deepen your project together by
               phone and email.
            </Typography>
                  ...
                  <Grid container sx={{ mt: 6 }} spacing={2}>
                     ...
                     <Grid item xs={12} sm={12}>
                        ...
                        >
                           ...
                           {errors.destinations && (
                              <FormHelperText>
                                 Write atleast one destination or more
                                 than one
                              </FormHelperText>
                           )}
                        </FormControl>
                     ...
                     <Grid item xs={12} sm={12} sx={{ mt: 5 }}>
                        <Typography
                           ...
                           sx={{ mb: 2 }}
                        >
                           What theme and / or type of trip would you
                           like? (several choices possible)
                        </Typography>
                     ...
                     <Grid item xs={12} sm={12} sx={{ mt: 4 }}>
                        ...
                        >
                           <Typography
                              ...
                              sx={{ mb: 1 }}
                           >
                              Global budget in euros per person for
                              this trip? (about)
                           </Typography>
                           <input
                              className={classes.textInput}
                           ...
                           {errors.globalBudget && (
                              <FormHelperText>
                                 Specify the global budget per person
                                 for this trip
                              </FormHelperText>
                           )}
                        </FormControl>
                     ...
                     <Grid item xs={12} sm={12} sx={{ mt: 5 }}>
                        <Typography
                           ...
                           sx={{ mb: 1 }}
                        >
                           When is the best time to reach you by
                           phone?
                        </Typography>
                        <Controller
